    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_state', models.CharField(choices=[('open', 'Open'), ('ongoing', 'Ongoing'), ('canceled', 'Canceled'), ('contract canceled and reopened', 'Contract Canceled And Reopened')], default='open', max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),

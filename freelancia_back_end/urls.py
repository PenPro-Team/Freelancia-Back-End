...
from freelancia_back_end.views import ProjectSearchFilterView,ProjectAPI, ProjectView, ProposalAPI, SkillAPI, proposal_by_project, proposal_by_user, proposal_detail, proposal_list, skill_list, userView

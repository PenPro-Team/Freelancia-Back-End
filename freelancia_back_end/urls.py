...
from freelancia_back_end.views import CertificateViewSet, CustomAuthToken, HighestRatedClientsView, HighestRatedFreelancersView, LogoutView, ProjectsPerUser, SpecialityView, ProjectSearchFilterView, ProjectAPI, ProjectView, ProposalAPI, ProposalViewAndCreate, SkillAPI, UserDetailView, api_root, proposal_by_project, proposal_by_user, proposal_detail, proposal_list, skill_list, userView,UserSearch
...
urlpatterns = [
    ...
    path('projects/user/', ProjectsPerUser, name='projects-per-user'),
